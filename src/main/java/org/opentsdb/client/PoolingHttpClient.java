...
import org.opentsdb.client.builder.HttpClientConfiguration;
...
public class PoolingHttpClient {
	...
	protected int connectTimeout = DEFAULT_CONNECTION_TIMEOUT_MILLISECONDS;
	protected int readTimeout = DEFAULT_READ_TIMEOUT_MILLISECONDS;
	protected int waitTimeout = DEFAULT_WAIT_TIMEOUT_MILLISECONDS;
	...
	public PoolingHttpClient(HttpClientConfiguration configuration) {
	...
	private void updateConfig(HttpClientConfiguration configuration) {
		if(configuration != null) {
			...
			if(configuration.getWaitTimeout() != null) {
